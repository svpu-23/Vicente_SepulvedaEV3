...
export default function NavbarCafe() {
  ...
  return (
    <Navbar expanded={expanded} onToggle={(nextExpand) => setExpanded(nextExpand)} expand="lg" bg="dark" variant="dark" sticky="top" className="shadow-sm px-3">
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center">
            ...
            <Button variant="outline-warning" className="ms-lg-3 mt-2 mt-lg-0" onClick={() => alert('¡Redireccionando al sistema de reservas!')}>
              Reservar Mesa
            </Button>
          </Nav>
        </Navbar.Collapse>
